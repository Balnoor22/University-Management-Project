...
public class AddStudent extends JFrame implements ActionListener
{
    ...
    AddStudent()
    {
        ...
        jrollno=new JLabel("1533"+first4);
        jrollno.setBounds(200,200,200,30);
        jrollno.setFont(new Font("serif",Font.BOLD,20));
        add(jrollno);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()==submit)
        {
            ...
            try
            {
                String query="insert into student values('"+name+"','"+father+"','"+rollno+"','"+dob+"','"+address+"','"+phone+"','"+email+"','"+x+"','"+xii+"','"+aadhar+"','"+course+"','"+branch+"')";
